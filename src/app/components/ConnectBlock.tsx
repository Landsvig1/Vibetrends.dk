...
// For skills, presents a super-clean, direct "INSTALLATION: Code" block that works across
// all AI agents without requiring host tab selection.
export default function ConnectBlock({
  ...
  // Direct, simple INSTALLATION block for skills across AI agents
  if (feedType === "skills") {
