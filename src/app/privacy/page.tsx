    ...
    <div className="max-w-3xl mx-auto space-y-8 py-8">
      <div className="space-y-4">
        <h1 className="text-3xl font-extrabold tracking-tight text-white md:text-4xl">
          Privatlivspolitik for <span className="text-cyan-400">vibetrends.dk</span>
        </h1>
      ...
      <div className="prose prose-invert text-slate-300 space-y-6 text-sm leading-relaxed">
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-white">1. Dataansvarlig</h2>
          <p>
            Vibetrends.dk er ejet og drevet af Kasper Landsvig, Brøndby, Danmark. Kontakt os på{" "}
            <a href="mailto:kasper@aiauto.dk" className="text-cyan-400 hover:underline">
              kasper@aiauto.dk
            </a>{" "}
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-white">2. Ingen sporingscookies</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-white">3. Indsamling af oplysninger ved booking</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-white">4. Dine rettigheder</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-white">5. Klageadgang</h2>
          <p>
